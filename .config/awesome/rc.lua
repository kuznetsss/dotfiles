...
beautiful.init("/home/sergey/.config/awesome/default/theme.lua")
...
globalkeys = awful.util.table.join(
	...
	awful.key({ }, "Scroll_Lock", function () awful.spawn("dm-tool lock") end,
    ...
    awful.key({ "Shift" }, "Print", function () awful.spawn.with_shell("scrot -s") end,
	...
	awful.key({ }, "XF86MonBrightnessDown",
		...
		{description = "set backlight lower", group = "launcher"}),
	awful.key({ }, "XF86MonBrightnessUp",
			function() awful.spawn.with_shell("light -A 5") end,
			{description = "set backlight highter", group = "launcher"}),
	awful.key({ }, "XF86AudioRaiseVolume",
			function() awful.spawn.with_shell("amixer set Master Playback 5%+") end,
			{description = "raise volume", group = "launcher"}),
	awful.key({ }, "XF86AudioLowerVolume",
			function() awful.spawn.with_shell("amixer set Master Playback 5%-") end,
			{description = "lower volume", group = "launcher"}),
	awful.key({ }, "XF86AudioMute",
			function() awful.spawn.with_shell("amixer set Master toggle") end,
	...
	awful.key({ }, "XF86TouchpadToggle",
		...
		{description = "turn on/off the touchpad", group = "launcher"})
)
...
run_once(terminal)
awful.spawn("/home/sergey/.scripts/auto_choose_display.sh")
